...
library LibAsset {
    ...
    function issueBitoroToken(Asset storage token, address recipient, uint256 bitoroTokenAmount) internal {
        IERC20Upgradeable(token.bitoroTokenAddress).safeTransfer(recipient, bitoroTokenAmount);
    }
