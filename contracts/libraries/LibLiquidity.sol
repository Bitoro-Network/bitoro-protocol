...
library LibLiquidity {
    ...
    function redeemBitoroToken(
        ...
        require(bitoroTokenAmount != 0, "A=0"); // Amount Is Zero
        ...
        require(token.spotLiquidity >= bitoroTokenAmount, "LIQ"); // insufficient LIQuidity
        uint256 rawAmount = token.toRaw(bitoroTokenAmount);
        token.spotLiquidity -= bitoroTokenAmount;
    ...
    function rebalance(
        ...
        uint96 rawAmount1;
        {
            ...
            IBitoroRebalancerCallback(rebalancer).bitoroRebalanceCallback(
                token0.tokenAddress,
                token1.tokenAddress,
                rawAmount0,
                expectedRawAmount1,
